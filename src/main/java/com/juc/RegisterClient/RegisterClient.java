...
public class RegisterClient {
     ...
     * 客户端缓存的注册表
     */
    private ClientCachedServiceRegistry registery;
    ...
    public RegisterClient() {
        ...
        this.isRunning = true;
        this.registery = new ClientCachedServiceRegistry(this,httpSender);
    }
    ...
    public void shutdown() {
        ...
        this.registery.destroy();
    }

    /*
    * 返回RegitserClient是否正常运行
    * */
